...
description: "An experiment in using LLMs to automate social science writing. Here's what I learned about LLM-assisted social science blogging."
tags:
  - census
  - demographics
  - llm
...
_Edit: This post is part 1 of what became a 2 part series. Part 1 focuses on the initial learnings of setting up the initial agentic workflow while [Part 2](/posts/census-monkey-typewriter-pt2-multiagent/) covers the transition and improvement from moving to a multi-agent orchestration._
