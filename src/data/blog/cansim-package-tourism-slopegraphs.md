...
This post also demonstrates a couple of different approaches for displaying chronological rankings, using a new package for [Tuftian](https://en.wikipedia.org/wiki/Edward_Tufte) [slopegraphs](https://github.com/leeper/slopegraph) by [Thomas Leeper](https://twitter.com/thosjleeper) and to see how it compares to one of my favourite chart-types, the [dumbell plot](http://datavizproject.com/data-type/dumbbell-plot/) from the [ggalt](https://github.com/hrbrmstr/ggalt) package by [Bob Rudis](https://twitter.com/hrbrmstr), and when one is more appropriate to use than another one.
...
![](/post/2018-08-01-cansim-package-tourism-slopegraphs_files/figure-html/most_visited-1.png)
...
![](/post/2018-08-01-cansim-package-tourism-slopegraphs_files/figure-html/most_spending-1.png)
...
![](/post/2018-08-01-cansim-package-tourism-slopegraphs_files/figure-html/slope_spend-1.png)
...
![](/post/2018-08-01-cansim-package-tourism-slopegraphs_files/figure-html/dumbell_visits-1.png)

And for tourism expenditures:

![](/post/2018-08-01-cansim-package-tourism-slopegraphs_files/figure-html/dumbell_spend-1.png)
...
![](/post/2018-08-01-cansim-package-tourism-slopegraphs_files/figure-html/indexed_visits-1.png)
...
![](/post/2018-08-01-cansim-package-tourism-slopegraphs_files/figure-html/indexed_spend-1.png)
